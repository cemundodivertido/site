jQuery(document).on('action.init_hidden_elements',function(e,cont){"use strict";if(KIDSCARE_STORAGE['button_hover']&&KIDSCARE_STORAGE['button_hover']!='default'){jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+KIDSCARE_STORAGE['button_hover']);if(KIDSCARE_STORAGE['button_hover']!='arrow'){jQuery('input[type="submit"]:not([class*="sc_button_hover_"]),\
